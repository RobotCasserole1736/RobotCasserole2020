 ...
 */
public class AutoEventSteakAuto extends AutoEvent {
    ...
    private final Waypoint[] waypoints_ft = new Waypoint[] {
        ...
        new Waypoint(9,  -13.2,  Pathfinder.d2r(0)),
        new Waypoint(16, -13.2,  Pathfinder.d2r(0)),
    };

    public AutoEventSteakAuto() {
    ...
    public static void main(String[] args) {
        ...
        AutoEventSteakAuto autoEvent = new AutoEventSteakAuto();
		//TODO
