 ...
 * go to scale on left.
 */
public class AutoEventSideSteakB extends AutoEvent {
    ...
    public AutoEventSideSteakB(double intkPrepDuration_s_in) {
    ...
    public static void main(String[] args) {
        AutoEventSideSteakB autoEvent = new AutoEventSideSteakB(1.0); //time is for intk
		//TODO
