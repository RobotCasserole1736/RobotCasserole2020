...
import frc.robot.Drivetrain.RobotPose;
...
public class AutoEventJevoisPathPlan extends AutoEvent {
     ...
     */
    public AutoEventJevoisPathPlan(double tgt_pos_y_ft, double tgt_pos_x_ft, double tgt_pos_angle_rad){
